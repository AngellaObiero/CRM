        ...
        -->
          ...
          <div class="sidebar-wrapper">
            <ul class="nav">
              ...
              <li class="nav-item ">
                <a class="nav-link" href="../resources/views/icons.blade.php">
                  <i class="material-icons">bubble_chart</i>
                  <p>Icons</p>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="../resources/views/map.blade.php">
              ...
              <li class="nav-item ">
                <a class="nav-link" href="../resources/views/rtl.blade.php">
                  <i class="material-icons">language</i>
                  <p>RTL Support</p>
                </a>
              </li>
              <li class="nav-item active-pro ">
                <a class="nav-link" href="../resources/views/upgrade.blade.php">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="#">@angella_obiero mentioned you in a tweet</a>
                      <a class="dropdown-item" href="#">Tomorrow is Jamhuri Day</a>
                      <a class="dropdown-item" href="#">Legibra sent a survey form</a>
                    </div>
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                      <a class="dropdown-item" href="../resources/views/user.blade.php">Profile</a>
